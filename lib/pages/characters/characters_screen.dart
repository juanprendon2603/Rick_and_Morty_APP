        ...
        itemBuilder: (BuildContext context, int index) {
          return ListTile(
            leading: CircleAvatar(
              child:
                  Image(image: NetworkImage(provider.characters[index].image)),
            ),
            trailing: Text(
                ...
                builder: (context) {
                  ...
                  return Center(
                    child: Dialog(
                        ...
                        child: SizedBox(
                          height: size.height * sizedBoxDialogCharacters,
                          child: Stack(
                            children: [
                              Positioned(
                                  top: (size.height * dialogPositioned) / 2,
                                  child: Container(
                                    margin: EdgeInsets.only(
                                        top: size.height * dialogMargin),
                                    ...
                                    height:
                                        size.height * dialogHeigthCharacters,
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          columnDialog(
                                              tOrigin,
                                              provider.characters[index].origin,
                                              size),
                                          const SizedBox(
                                            height: sizedBoxDialog,
                                          ),
